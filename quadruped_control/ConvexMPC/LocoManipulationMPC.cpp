...
/* =========================== Controller ============================= */
LocoManipulationMPC::LocoManipulationMPC(double _dt, int _iterations_between_mpc, int horizon) 
...
void LocoManipulationMPC::run(ControlFSMData &data)
{
 ...
 //Integral-esque pitch and roll compensation
  ...
  for(int i = 0; i < 4; i++)
  {
    ...
    //if((swingTimeRemaining[i]*1000)%5 == 0)  
