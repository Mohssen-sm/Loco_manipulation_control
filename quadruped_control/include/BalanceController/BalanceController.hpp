...
double_t exit_flag;
double_t nWSR;
double_t cpu_time_microseconds;
double_t xOpt[12];
double_t p_des[3];
double_t p_act[3];
double_t v_des[3];
...
double_t active;
double_t pfeet_des[12];
double_t pfeet_act[12]; 
};
...
class BalanceController {
 ...
 private:
  ...
  sparse_int_t nWSR_qpOASES = 100;
  sparse_int_t nWSR_fixed = 100;
  
  real_t cpu_time;
  real_t cpu_time_fixed;

  sparse_int_t qp_exit_flag;
